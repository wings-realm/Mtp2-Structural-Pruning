...
commands = [
    {
        ...
        "cmd": f"python3 ddpm_hessian2_prune.py --dataset cifar10 --model_path pretrained/ddpm_ema_cifar10 --save_path run/pruned/ddpm_cifar10_pruned --pruning_ratio {pruning_ratio} --batch_size 64 --pruner taylor2 --thr 0.05 --device {{device}}"
    },
    {
